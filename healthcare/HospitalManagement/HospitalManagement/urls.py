...
from hospital.views import register_user,login_user,doctor,patient,logou_user,createpatient,patientupdateview,detailviewdoctor,patientlist,PatientApi,home
urlpatterns = [
